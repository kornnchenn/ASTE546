...
public:	
	...
	void addTubeBox(double3 corner1, double3 corner2, double holeRadius, double phi_object);
	
	/*return true if point x is inside or on the sphere*/
	bool inSphere(double3 x);
	bool inBox(double3 point, double3 min, double3 max, double holeRadius);
	bool inCylinder(double3 point, double holeRadius);
